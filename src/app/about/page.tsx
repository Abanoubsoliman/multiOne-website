      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">About MultiOne</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              We are a team of passionate developers and digital experts dedicated to helping businesses succeed in the digital world.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">
                To be the leading digital transformation partner for businesses worldwide, known for our innovation, expertise, and commitment to client success.
              </p>
            </div>
          </div>
        </div>
...
const values = [
  ...
  },
  {
    ...
    title: "Growth",
    description: "We are committed to continuous improvement and helping our clients grow.",
  },
]; 